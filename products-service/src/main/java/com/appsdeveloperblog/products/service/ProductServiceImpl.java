...
import com.appsdeveloperblog.core.exception.ProductInsufficientQuantityException;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product reserve(Product desiredProduct, UUID orderId) {
        ...
        return new Product(productEntity.getId(), productEntity.getName(), productEntity.getPrice(), desiredProduct.quantity());
    }
